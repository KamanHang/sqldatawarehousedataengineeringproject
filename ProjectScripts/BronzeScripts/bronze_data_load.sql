...
BEGIN
    ...
    COPY bronze.crm_cust_info FROM 'C:/Users/NashibPC/Desktop/sqldatawarehousedataengineeringproject/Datasets/source_crm/cust_info.csv' DELIMITER ',' CSV HEADER;
    ...
    COPY bronze.crm_prd_info FROM 'C:/Users/NashibPC/Desktop/sqldatawarehousedataengineeringproject/Datasets/source_crm/prd_info.csv' DELIMITER ',' CSV HEADER;
    RAISE NOTICE 'Inserting Data COMPLETED';
	-- Record End Time and Load Duration	
    end_time := CURRENT_TIMESTAMP;
    load_duration := end_time - start_time;
    ...
    COPY bronze.crm_sales_details FROM 'C:/Users/NashibPC/Desktop/sqldatawarehousedataengineeringproject/Datasets/source_crm/sales_details.csv' DELIMITER ',' CSV HEADER;
    RAISE NOTICE 'Inserting Data COMPLETED';
	-- Record End Time and Load Duration	
    end_time := CURRENT_TIMESTAMP;
    load_duration := end_time - start_time;
    ...
    COPY bronze.erp_loc_a101 FROM 'C:/Users/NashibPC/Desktop/sqldatawarehousedataengineeringproject/Datasets/source_erp/LOC_A101.csv' DELIMITER ',' CSV HEADER;
    RAISE NOTICE 'Inserting Data COMPLETED';
	-- Record End Time and Load Duration	
    end_time := CURRENT_TIMESTAMP;
    load_duration := end_time - start_time;
    ...
    COPY bronze.erp_cust_az12 FROM 'C:/Users/NashibPC/Desktop/sqldatawarehousedataengineeringproject/Datasets/source_erp/CUST_AZ12.csv' DELIMITER ',' CSV HEADER;
    RAISE NOTICE 'Inserting Data COMPLETED';
	-- Record End Time and Load Duration	
    end_time := CURRENT_TIMESTAMP;
    load_duration := end_time - start_time;
    ...
    COPY bronze.erp_px_cat_g1v2 FROM 'C:/Users/NashibPC/Desktop/sqldatawarehousedataengineeringproject/Datasets/source_erp/PX_CAT_G1V2.csv' DELIMITER ',' CSV HEADER;
    RAISE NOTICE 'Inserting Data COMPLETED';
	-- Record End Time and Load Duration	
    end_time := CURRENT_TIMESTAMP;
    load_duration := end_time - start_time;
